...
import { A as isNonNullable, At as JSONParseError, B as readResponseWithSizeLimit, Bt as isJSONObject, C as dynamicTool, Ct as unknown, D as getErrorMessage$1, Dt as InvalidArgumentError$1, E as generateId, Et as EmptyResponseBodyError, F as normalizeHeaders, Ft as TooManyEmbeddingValuesForCallError, G as validateTypes, H as safeParseJSON, I as parseJsonEventStream, It as TypeValidationError, J as zodSchema, K as withUserAgentSuffix, Lt as UnsupportedFunctionalityError, M as isUrlSupported, Mt as LoadSettingError, N as jsonSchema, Nt as NoContentGeneratedError, O as getRuntimeEnvironmentUserAgent, Ot as InvalidPromptError, P as lazySchema, Pt as NoSuchModelError, Rt as getErrorMessage, St as union, T as fetchWithValidatedRedirects, Tt as APICallError, U as safeValidateTypes, V as resolve, W as tool, _t as number, at as _enum, bt as strictObject, c as DelayedPromise, d as cancelResponseBody, dt as custom, ft as discriminatedUnion, g as convertUint8ArrayToBase64, gt as never, i as gateway, jt as LoadAPIKeyError, k as isAbortError, kt as InvalidResponseDataError, l as DownloadError, lt as array$1, mt as literal, n as GatewayError, ot as _instanceof, p as convertBase64ToUint8Array, pt as lazy, r as createGatewayProvider, s as DEFAULT_MAX_DOWNLOAD_SIZE, st as _null, t as GatewayAuthenticationError, u as asSchema, ut as boolean, v as createIdGenerator, vt as object$1, w as executeTool, wt as AISDKError, x as delay, xt as string, yt as record, zt as isJSONArray } from "./@ai-sdk/gateway+[...].mjs";
...
function normalizePrompt2(promptArg) {
	...
	if (promptArg.image != null) {
		...
		if (typeof dataContent === "string") if (dataContent.startsWith("http://") || dataContent.startsWith("https://")) image = {
			type: "url",
			url: dataContent
		};
		...
		else if (dataContent instanceof Uint8Array) image = {
			type: "file",
