...
import { a as X_TSS_RAW_RESPONSE, d as getStartContext, f as runWithStartContext, i as TSS_SERVER_FUNCTION, l as flattenMiddlewares, n as TSS_CONTENT_TYPE_FRAMED_VERSIONED, o as X_TSS_SERIALIZED, p as safeObjectMerge, r as TSS_FORMDATA_CONTEXT, s as createNullProtoObject, t as FrameType, u as getDefaultSerovalPlugins } from "./esm-B50dUWcE.mjs";
import { t as createCsrfMiddleware } from "./createStart-DwZhSttb.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DWs5i0RM.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-7V0qJ1gO.mjs"),
		import("./start-CB9scq1k.mjs"),
