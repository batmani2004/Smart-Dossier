...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0f172a] px-4">
      <div className="w-full max-w-sm rounded-2xl border border-slate-700 bg-slate-800 p-10 text-center shadow-2xl">
        ...
        <p className="mt-2 text-sm text-slate-400">
          We ran into an unexpected error. Try refreshing — if it keeps happening, head back home.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Smart Dossier — AI-Powered Property Procedure Management" },
      {
        name: "description",
        content:
          "AI platform for managing property procedures in Albania — expropriation and HCA privatization.",
      },
      { name: "author", content: "Innovation4Albania" },
      { property: "og:title", content: "Smart Dossier — AI-Powered Property Procedure Management" },
      {
